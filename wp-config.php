...
define('WPRO_AWS_BUCKET', getenv('AWS_BUCKET')); // The name of the Amazon S3 bucket where your files should be stored.
define('WPRO_AWS_VIRTHOST', getenv('AWS_VIRTHOST')); // If you have a virthost for your Amazon S3 bucket, it should be there.
define('WPRO_AWS_ENDPOINT', getenv('AWS_ENDPOINT')); // The Amazon endpoint datacenter where your S3 bucket is. Se list of endpoints below.
/*
